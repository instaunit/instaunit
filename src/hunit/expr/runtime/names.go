...
func companyName() string {
	switch rand.Intn(3) {
	case 0:
		return cname1[rand.Intn(len(cname1))] + " " + cname2[rand.Intn(len(cname2))]
	case 1:
		return cname3[rand.Intn(len(cname3))]
	case 2:
		return cname4[rand.Intn(len(cname4))] + cname5[rand.Intn(len(cname5))]
	default:
		return "<invalid>"
	}
}
